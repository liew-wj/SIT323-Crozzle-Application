...
namespace CrozzleApplication
{
    public class WordDataList
    {
        ...
        #region properties
        public List<SequenceFragment> OriginalWordDataList { get; set; }
        ...
        #region constructors
        public WordDataList(List<SequenceFragment> originalList)
        {
        ...
        #region parsing
        public static Boolean TryParse(List<SequenceFragment> originalWordDataList, Crozzle aCrozzle, out WordDataList aWordDataList)
        {
            ...
            foreach (SequenceFragment fragment in originalWordDataList)
            {
                WordData aWordData;
                if (WordData.TryParse(fragment, aCrozzle, out aWordData))
